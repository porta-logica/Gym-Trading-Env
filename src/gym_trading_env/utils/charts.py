...
def charts(df, lines=[]):
    ...
    grid_chart.add(
        ...
        grid_opts=opts.GridOpts(
            pos_left="10%", pos_right="8%", pos_top=architecture["candlesticks"]["top_%"],
            height=architecture["candlesticks"]["height_%"]),
    )
    grid_chart.add(
        volumes,
        grid_opts=opts.GridOpts(
            pos_left="10%", pos_right="8%", pos_top=architecture["volumes"]["top_%"],
            height=architecture["volumes"]["height_%"]
        ),
    )
    grid_chart.add(
        portfolios,
        grid_opts=opts.GridOpts(
            pos_left="10%", pos_right="8%", pos_top=architecture["portfolios"]["top_%"],
            height=architecture["portfolios"]["height_%"]
        ),
    )
    grid_chart.add(
        positions,
        grid_opts=opts.GridOpts(
            pos_left="10%", pos_right="8%", pos_top=architecture["positions"]["top_%"],
            height=architecture["positions"]["height_%"]
        ),
    )
    grid_chart.add(
        rewards,
        grid_opts=opts.GridOpts(
            pos_left="10%", pos_right="8%", pos_top=architecture["rewards"]["top_%"],
            height=architecture["rewards"]["height_%"]
        ),
    )
